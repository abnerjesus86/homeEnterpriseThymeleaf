...
<link rel="stylesheet" href="${pageContext.request.contextPath}/res/pages/users/css/style.css" />
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							Account User <small> <i class="ace-icon fa fa-angle-double-right"></i> permission
							</small>
						</h1>
					</div>
					...
					<div class="row">
						<div class="col-xs-12">
                            ...
                            <div id="dialog-confirm" class="hide">
                                <div class="alert alert-info bigger-110">Se deshabilitara la siguiente cuenta de usuario.</div>
...
<![endif]-->
	...
	<script src="${pageContext.request.contextPath}/res/pages/users/js/script.js"></script>
