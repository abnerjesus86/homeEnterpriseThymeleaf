					...
					oTable1 =
						...
						.DataTable({
							...
							oLanguage: {
								...
								sLengthMen: "Mostrar _MENU_ Registros",
						...
						var tableEvents = $('#TablaEventos').dataTable({
                            ...
                            initComplete: function(oSettings, json) {
                                ...
                                $('#TablaEventos tbody').on('click', 'td.details-control', function() {
                                    ...
                                    if (row.child.isShown()) { //Contraer
										...
										$( "input[type=checkbox]" ).on( "click", function() {
										 // console.log( $( "input:checked" ).val() + " is checked!" );
										  //console.log('filtroImagenes :'+$("#filtroImagenes").prop("checked"));
										  //console.log('filtroVideos :'+$("#filtroVideos").prop("checked"));
									...
									//$('#GaleriaFotos').after('<script src="../assets/plugins/simpleportafolio/js/featherlight.gallery.min.js" type="text/javascript" charset="utf-8"></script>');
									console.log($('#GaleriaFotos').html());
									//$('.gallery').featherlightGallery();
												
											$('#TablaEventos tbody .sp-simpleportfolio-item .sp-simpleportfolio-overlay a').click(function()
											{											
												console.log('Click a la imagen: '+$(this).get(0));

												if (op_Zoom)
												{													
													var ImgURL = $(this).get(0);
													...
													window.setTimeout(function() 
													{											
														$('.featherlight-content img').addClass('image-zoom').addClass('gallery').attr('data-zoom-image',ImgURL).after('<script src="../assets/plugins/elevatezoom/jquery.elevatezoom.js" type="text/javascript" charset="utf-8"></script>').after('<script src="../assets/plugins/simpleportafolio/js/featherlight.gallery.min.js" type="text/javascript" charset="utf-8"></script>');
														
														
														/*$('.featherlight-content img').elevateZoom(
														{
															zoomType: "inner",
															cursor: "crosshair",
														...
														$.featherlight.defaults.afterClose = function(){$('.zoomContainer').remove()};*/
														
														/*console.log($('.featherlight-content img').get(0));*/
														//$('.featherlight-content img').after('<script src="../assets/plugins/simpleportafolio/js/featherlight.gallery.min.js" type="text/javascript" charset="utf-8"></script>');
									...
									$('#TablaEventos').after('<div class="row">'+
									'<link href="http://noelboss.github.io/featherlight/assets/stylesheets/bootstrap.min.css" rel="stylesheet" />'+
									'<link type="text/css" rel="stylesheet" href="http://noelboss.github.io/featherlight/release/featherlight.gallery.min.css" />'+
									'<link type="text/css" rel="stylesheet" href="http://noelboss.github.io/featherlight/release/featherlight.min.css" />'+
										'<div class="row">'+
											'<div class="col-lg-2">'+
												'<a class="thumbnail gallery" href="http://10.130.66.46:8887/Lane2/141031/332827_ContRightUpper_f.jpg">'+'<img src="http://10.130.66.46:8887/Lane2/141031/332827_ContRightUpper_f.jpg" />'+'</a>'+
											'</div>'+
											'<div class="col-lg-2">'+
												'<a class="thumbnail gallery" href="http://10.130.66.46:8887/Lane2/141031/332827_ContLeftUpper_f.jpg">'+'<img src="http://10.130.66.46:8887/Lane2/141031/332827_ContLeftUpper_f.jpg" />'+'</a>'+
											'</div>'+
										'</div>'+
									'<script src="http://noelboss.github.io/featherlight/assets/javascripts/jquery-1.7.0.min.js">'+'</script>'+
									'<script src="http://noelboss.github.io/featherlight/release/featherlight.min.js" type="text/javascript" charset="utf-8">'+'</script>'+
									'<script src="../assets/plugins/simpleportafolio/js/featherlight.gallery.min.js" type="text/javascript" charset="utf-8">'+'</script>');
								'</div>';
						   ...
						   $.each(element.images, function(index, element)
							{
								...
								Galery = Galery +
											//'<div class="sp-simpleportfolio-item imagesgroup" data-groups=\'["' + side + '"]\'   >' +
													'<div class="col-lg-2">'+
														'<a class="thumbnail gallery" href="'+ ImageURL +'"><img src="'+ ImageURL +'" /></a>'+
													'</div>';
												//'</div>';
									/*'<div class="sp-simpleportfolio-item imagesgroup" data-groups=\'["' + side + '"]\'   >' +
										'<div class="sp-simpleportfolio-overlay-wrapper clearfix ">' +
											...
											'<div class="sp-simpleportfolio-overlay">' +
												'<a class="gallery btn-zoom" href="'+ ImageURL +'" data-featherlight="image" >' +
