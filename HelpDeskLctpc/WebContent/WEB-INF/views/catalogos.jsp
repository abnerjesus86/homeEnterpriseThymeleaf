...
<link rel="stylesheet" href="${pageContext.request.contextPath}/res/pages/catalog/css/style.css" />
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							Administration <small> <i class="ace-icon fa fa-angle-double-right"></i> catalogs
							</small>
						</h1>
					</div>
						...
						<div class="col-xs-12">
							<div class="tabbable">
								<ul class="nav nav-tabs padding-18" id="myTab">
									<li class="active"><a data-toggle="tab" href="#faq-tab-1"> <i class="blue ace-icon fa fa-question-circle bigger-120"></i>
											Applications
									</a></li>
									<li><a data-toggle="tab" href="#faq-tab-2"> <i class="green ace-icon fa fa-user bigger-120"></i> Pages
									</a></li>
									<li><a data-toggle="tab" href="#faq-tab-3"> <i class="orange ace-icon fa fa-credit-card bigger-120"></i> Permission
									</a></li>
									<li><a data-toggle="tab" href="#faq-tab-4"> <i class="orange ace-icon fa fa-credit-card bigger-120"></i> Secret Questions
									</a></li>
									<li><a data-toggle="tab" href="#faq-tab-5"> <i class="orange ace-icon fa fa-credit-card bigger-120"></i> Entities
									</a></li>
								</ul>
								<!-- /section:pages/faq -->
								<div class="tab-content no-border padding-24">
									<div id="faq-tab-1" class="tab-pane fade in active">
										<p>
											<a href="#formularioModal" class="btn btn-primary" id="btn-addApplication" role="button" data-toggle="modal"> <i
												class="ace-icon glyphicon glyphicon-plus"></i> New
											</a>
									...
									<div id="faq-tab-2" class="tab-pane fade">
										<p>
											<a href="#formularioModal" class="btn btn-primary" id="btn-addPage" role="button" data-toggle="modal"> <i
												class="ace-icon glyphicon glyphicon-plus"></i> New
											</a>
										</p>
									...
									<div id="faq-tab-3" class="tab-pane fade">
										<p>
											<a href="#formularioModal" class="btn btn-primary" id="btn-addPermission" role="button" data-toggle="modal"> <i
												class="ace-icon glyphicon glyphicon-plus"></i> New
											</a>
