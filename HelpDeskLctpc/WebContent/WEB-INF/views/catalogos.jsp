...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/assets/css/bootstrap.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/assets/css/font-awesome.css" />

<!-- page specific plugin styles -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/assets/css/jquery-ui.custom.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/assets/css/chosen.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/assets/css/jquery-ui.css" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/res/assets/css/bootstrap-multiselect.css" />
        <link rel="stylesheet" href="${pageContext.request.contextPath}/res/assets/css/select2.css" />

<!-- text fonts -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/assets/css/ace-fonts.css" />

<!-- ace styles -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/assets/css/ace.css"
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/pages/catalog/css/style.css" />

<!-- ace settings handler -->
<script
	src="${pageContext.request.contextPath}/res/assets/js/ace-extra.js"></script>
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/assets/css/ace.onpage-help.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/res/docs/assets/js/themes/sunburst.css" />
</head>
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="#" class="navbar-brand"> <small><img
						class="nav-user-photo" height="27"
						src="${pageContext.request.contextPath}/res/assets/logos/Logo_HutchisonPorts_White.png">
				</small>
				</a>
				...
				<ul class="nav ace-nav">
							...
							<li class="dropdown-content">
								<ul class="dropdown-menu dropdown-navbar">
									<li><a href="#" class="clearfix"> <img
											src="${pageContext.request.contextPath}/res/assets/avatars/avatar.png"
									...
									<li><a href="#" class="clearfix"> <img
											src="${pageContext.request.contextPath}/res/assets/avatars/avatar3.png"
									...
									<li><a href="#" class="clearfix"> <img
											src="${pageContext.request.contextPath}/res/assets/avatars/avatar4.png"
									...
									<li><a href="#" class="clearfix"> <img
											src="${pageContext.request.contextPath}/res/assets/avatars/avatar2.png"
									...
									<li><a href="#" class="clearfix"> <img
											src="${pageContext.request.contextPath}/res/assets/avatars/avatar5.png"
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="${pageContext.request.contextPath}/res/assets/avatars/user.png"
			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="page-header">
						<h1>
							Administration <small> <i
								class="ace-icon fa fa-angle-double-right"></i> catalogs
							</small>
						</h1>
					</div>
					<!-- /.ace-settings-container -->
					<div id="formularioModal" class="modal fade" tabindex="-1">
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								<div class="modal-header">
									...
									<h4 class="modal-title" id="gridModalLabel">Form User</h4>
								</div>
					...
					<div id="dialog-confirm" class="hide">
						<div class="alert alert-info bigger-110">The following
							record will be disabled.</div>
							...
							<div class="tabbable">
								<ul class="nav nav-tabs padding-18" id="myTab">
									...
									<li><a data-toggle="tab" href="#faq-tab-2"> <i
											class="green ace-icon fa fa-user bigger-120"></i> Pages
									</a></li>
								...
								<div class="tab-content no-border padding-24">
									<div id="faq-tab-1" class="tab-pane fade in active">
										<p>
										<a href="#formularioModal" class="btn btn-primary" id="btn-addApplication" role="button" data-toggle="modal">
									...
									<div id="faq-tab-2" class="tab-pane fade">
										<p>
										<a href="#formularioModal" class="btn btn-primary" id="btn-addPage" role="button" data-toggle="modal">
                                                <i class="ace-icon glyphicon glyphicon-plus"></i>
                                                New
                                            </a>
										</p>
									...
									<div id="faq-tab-3" class="tab-pane fade">
										<p>
										<a href="#formularioModal" class="btn btn-primary" id="btn-addPermission" role="button" data-toggle="modal">
                                                <i class="ace-icon glyphicon glyphicon-plus"></i>
                                                New
                                            </a>
									...
									<div id="faq-tab-4" class="tab-pane fade">
										<p>
										<a href="#formularioModal" class="btn btn-primary" id="btn-addSecretQuestion" role="button" data-toggle="modal">
                                                <i class="ace-icon glyphicon glyphicon-plus"></i>
                                                New
                                            </a>
											
										</p>
										<table id="tableSecretQuestion"
											class="table table-striped table-hover">
											<thead>
											</thead>
											<tbody>
									...
									<div id="faq-tab-5" class="tab-pane fade">
                                        <p>
                                        <a href="#formularioModal" class="btn btn-primary" id="btn-addEntities" role="button" data-toggle="modal">
                                                <i class="ace-icon glyphicon glyphicon-plus"></i>
                                                New
                                            </a>
                                        </p>
		...
		<div class="footer">
			<div class="footer-inner">
				...
				<div class="footer-content">
					<span class="bigger-120"> <span class="blue bolder">HelpDesk</span>
						Application &copy; 2016 Sistemas Portuarios LCTPC
					</span>
				</div>
...
<![endif]-->
	...
	<script
		src="${pageContext.request.contextPath}/res/assets/js/bootstrap.js"></script>

	<!-- page specific plugin scripts -->
	<script
		src="${pageContext.request.contextPath}/res/assets/js/jquery-ui.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/jquery.ui.touch-punch.js"></script>
	...
	<!-- ace scripts -->
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/elements.scroller.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/elements.colorpicker.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/elements.fileinput.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/elements.typeahead.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/elements.wysiwyg.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/elements.spinner.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/elements.treeview.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/elements.wizard.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/elements.aside.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/ace.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/ace.ajax-content.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/ace.touch-drag.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/ace.sidebar.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/ace.sidebar-scroll-1.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/ace.submenu-hover.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/ace.widget-box.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/ace.widget-on-reload.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/ace.searchbox-autocomplete.js"></script>

	<!-- inline scripts related to this page van los css que subi -->


	<script
		src="${pageContext.request.contextPath}/res/assets/js/dataTables/jquery.dataTables.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/dataTables/jquery.dataTables.bootstrap.js"></script>
	<script type="text/javascript">
		ace.vars['base'] = '..';
	</script>
	
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/elements.onpage-help.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/assets/js/ace/ace.onpage-help.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/docs/assets/js/rainbow.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/docs/assets/js/language/generic.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/docs/assets/js/language/html.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/docs/assets/js/language/css.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/docs/assets/js/language/javascript.js"></script>
	<script
		src="${pageContext.request.contextPath}/res/pages/catalog/js/script.js"></script>
