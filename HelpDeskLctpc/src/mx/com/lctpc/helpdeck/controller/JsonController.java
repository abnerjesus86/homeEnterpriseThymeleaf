...
public class JsonController {
	...
	public ResponseEntity<Map<String, List<Application>>> showAppsTable(  ) {
		...
		if(l_apps.isEmpty()){
            return new ResponseEntity<Map<String, List<Application>>>(HttpStatus.NO_CONTENT);//You many decide to return HttpStatus.NOT_FOUND
        }
	...
	public ResponseEntity<Map<String, List<UserRole>>> showJsonUserRoles(@PathVariable("p_IdUser") BigDecimal p_userId) {
		...
		if(l_userRoles.isEmpty()){
            return new ResponseEntity<Map<String, List<UserRole>>>(HttpStatus.NO_CONTENT);//You many decide to return HttpStatus.NOT_FOUND
        }
	...
	public ResponseEntity<Map<String, List<UserApplication>>> showJsonUserApps( @PathVariable("p_IdUser") BigDecimal p_userId) {
		...
		if(l_userApps.isEmpty()){
            return new ResponseEntity<Map<String, List<UserApplication>>>(HttpStatus.NO_CONTENT);//You many decide to return HttpStatus.NOT_FOUND
        }
	...
	public ResponseEntity<Map<String, List<Rol>> > showJsonRoles( ){
		...
		if(l_roles.isEmpty()){
            return new ResponseEntity<Map<String, List<Rol>>>(HttpStatus.NO_CONTENT);//You many decide to return HttpStatus.NOT_FOUND
        }
	...
	public ResponseEntity<Map<String, List<Permission>>> showJsonPermission(){
		...
		if(l_permissions.isEmpty()){
            return new ResponseEntity<Map<String, List<Permission>>>(HttpStatus.NO_CONTENT);//You many decide to return HttpStatus.NOT_FOUND
        }
	...
	public ResponseEntity<Map<String, List<SecretQuestion>>> showJsonsecretQuestions(){
		...
		if(l_secretQuestions.isEmpty()){
            return new ResponseEntity<Map<String, List<SecretQuestion>>>(HttpStatus.NO_CONTENT);//You many decide to return HttpStatus.NOT_FOUND
        }
	...
	public ResponseEntity<Map<String, List<AEntities>>> showJsonEntities(){
		...
		if(l_entities.isEmpty()){
            return new ResponseEntity<Map<String, List<AEntities>>>(HttpStatus.NO_CONTENT);//You many decide to return HttpStatus.NOT_FOUND
        }
	...
	public ResponseEntity<Map<String, List<ApplicationRole>>> showJsonRolesApps( @PathVariable("p_appId") BigDecimal p_appId) {
		...
		if(l_roleApps.isEmpty()){
            return new ResponseEntity<Map<String, List<ApplicationRole>>>(HttpStatus.NO_CONTENT);//You many decide to return HttpStatus.NOT_FOUND
        }
